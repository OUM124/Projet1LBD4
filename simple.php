...
<body>
    ...
    <input type="submit" name="Submit0" value="insert a new employee">
    <br>
    ...
    <a href="insert_into_db.php">insert a new employee</a>
    <br>
    <a href="update_salary.php">update the salary of an employee</a>
    <br>
    <a href="change_title.php">change the title of an employee</a>
    <br>
    <a href="affectation.php">affect an employee to a department</a>
